...
class PSDL(nn.Module):
	...
	def __init__(self, num_classes=19): # num_classes = 19 for CityScape data
		...
		self.semdecoder = semDecoder(in_channel_context=256*5, in_channels_block1=256, in_channels_block2=512)
		self.insdecoder = insDecoder(in_channel_context=256*5, in_channels_block1=256, in_channels_block2=512)
